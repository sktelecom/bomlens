...
이 프로젝트는 [Contributor Covenant](https://www.contributor-covenant.org/) 기반의 [행동 강령](CODE_OF_CONDUCT.ko.md)을 따릅니다. 프로젝트에 참여함으로써 이 강령을 지키는 데 동의하는 것으로 간주합니다. 보안 취약점은 [보안 정책](SECURITY.ko.md)에 따라 비공개로 신고해 주세요.
