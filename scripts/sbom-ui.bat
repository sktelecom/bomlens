...
set "M_PULL_1=  First run: downloading the scanner image (about 3-4 GB)."
set "M_PULL_2=  This can take several minutes depending on your network."
set "M_PULL_3=  Image:"
...
set "M_PULL_1=  처음 실행이라 스캐너 이미지를 내려받습니다 (약 3~4GB)."
set "M_PULL_2=  네트워크 상황에 따라 수 분 걸릴 수 있어요. 잠시 기다려 주세요."
set "M_PULL_3=  이미지:"
