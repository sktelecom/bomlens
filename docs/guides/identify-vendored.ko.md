...
결과는 확정이 아니라 근사 추정이므로 사람이 한 번 검토하는 편이 좋습니다. OSSKB 약관과 라이선스 설명은 [THIRD_PARTY_LICENSES.ko.md](https://github.com/sktelecom/bomlens/blob/main/THIRD_PARTY_LICENSES.ko.md)를 참조하세요.
