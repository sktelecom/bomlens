...
2. **앱 받아 실행**. [Windows용 BomLens 내려받기 (.exe)](https://github.com/sktelecom/sbom-tools/releases/latest/download/SBOM-Generator-Setup.exe)를
...
더 자세한 설명과 CLI 사용법은 [시작하기](getting-started.md)와
