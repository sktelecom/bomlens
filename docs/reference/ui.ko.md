...
**개요**는 주의가 필요한 항목을 먼저 보여줍니다. 심각·높음 취약점과 라이선스 검토가 필요한 컴포넌트를 앞세우고, 이어서 한눈에 보는 수치, 심각도 분포, 라이선스 요약을 두며, 각 상세 섹션으로 이동하는 카드를 제공합니다. 스캔이 아직 진행 중이면 실시간 로그가 다른 섹션이 아니라 이 개요에 표시됩니다.
